...
const THEME_MAP: Record<ThemeName, ThemeClasses> = {
  ...
  blue: {
    brandIconBg: 'bg-gradient-to-br from-blue-500 to-cyan-500',
    titleTextGradient: 'bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent',
    tabActiveBtn: 'bg-gradient-to-r from-blue-500 to-cyan-500 text-white shadow-md',
    headerBar: 'bg-gradient-to-r from-blue-500 to-cyan-500',
    userBubble: 'bg-gradient-to-r from-blue-500 to-cyan-500 text-white',
    primaryButton:
